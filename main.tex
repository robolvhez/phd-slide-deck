...
\graphicspath{{img/}{./}}
\usetikzlibrary{shapes.geometric, shapes.arrows, positioning, fit, backgrounds}
...
% Set author etc info
\title[E. Tutoral 2026-02]
{\bfseries
  % --- Spanish ---
  Estudios de Asociación Genómica
  Libres de Sesgos Poblacionales
  para Rasgos Complejos y Enfermedades
  en Más de 100 mil Mexicanos
}
...
\input{slides/2026-02/background.tex}
\input{slides/2026-02/objectives.tex}
\input{slides/2026-02/methods.tex}
\input{slides/2026-02/results.tex}
\input{slides/2026-02/conclusions.tex}

% Tutors
\input{slides/tutors.tex}
