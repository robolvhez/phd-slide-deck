...
\begin{frame}[c, fragile]{Selección de subcohortes}
  ...
  \resizebox{\textwidth}{!}{
    \begin{tikzpicture}[
      ...
      % Outputs
      \node[output] (related) at (6, 1.5) {\textbf{Individuos Emparentados}\\\textbf{$\sim$100,000 individuos}\\ \vspace{0.2cm} \small \textit{Para análisis FGWAS (efectos directos)}};
      \node[output] (unrelated) at (6, -1.5) {\textbf{Individuos No Emparentados}\\\textbf{$\sim$29,000 individuos}\\ \vspace{0.2cm} \small \textit{Para análisis GWAS poblacional}};
...
\begin{frame}[c, fragile]{Flujo de trabajo de SNIPAR}
  ...
  \resizebox{\textwidth}{!}{
    \begin{tikzpicture}[
      ...
      \draw[arrow] (impute.south) -- ++(0,-0.5) -| (gwas.north);
      \draw[arrow] (pheno.east) -| (gwas.south);
