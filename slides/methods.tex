...
\begin{frame}[c]{El estimador robusto (Guan et al., 2025)}
  \centering
  \begin{figure}
    \includegraphics[width=0.9\textwidth, height=0.75\textheight, keepaspectratio]{img/diagrams/robust-estimator_neff.png}
  ...
  \end{figure}
  {\tiny * Nota: Los tamaños de muestra efectivos precisos para la cohorte se encuentran en proceso de validación interna.}
\end{frame}



\begin{frame}[c]{Estructura familiar en la cohorte MCPS}
  \centering
  \begin{figure}
    \includegraphics[width=\textwidth, height=0.75\textheight, keepaspectratio]{img/diagrams/ziyatdinov2023-family-networks.png}
    \captionof{figure}{Redes familiares extensas dentro de la cohorte MCPS \parencite{ziyatdinov2023-mcps}.}
  \end{figure}
\end{frame}
